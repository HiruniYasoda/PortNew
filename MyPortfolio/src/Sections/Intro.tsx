    ...
    <section id="home" className="relative min-h-screen w-full bg-black overflow-hidden flex items-center pt-40">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center h-full">
        ...
        >
          ...
          {/* Admin Text Content Edit Pencil Button (Cleanly aligned top-right, no overlap!) */}
          {isAdmin && (
            <button
              onClick={() => setIsTextModalOpen(true)}
              className="absolute top-6 right-6 z-30 px-4 py-2 rounded-xl bg-purple-600 border border-purple-400/50 text-white shadow-[0_0_20px_rgba(168,85,247,0.7)] hover:scale-105 hover:bg-purple-500 transition-all flex items-center gap-2 text-xs font-bold"
          ...
          {/* Tagline */}
          <div className="inline-block mb-8 pr-16 md:pr-24">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.5 }}
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/40 border border-purple-400/40 text-purple-300 text-sm font-medium shadow-[0_0_15px_rgba(168,85,247,0.15)]"
            >
        ...
        >
          ...
          <div className="relative w-[320px] h-[320px] md:w-[500px] md:h-[500px] flex items-center justify-center group">
            ...
            <div className="relative w-[58%] h-[58%] rounded-full overflow-hidden border-[4px] border-purple-500/40 shadow-[0_0_60px_rgba(168,85,247,0.3)] z-10 bg-black">
              ...
              {/* Admin Profile Picture Pencil Overlay (Only shows on hover or click) */}
              {isAdmin && (
                <button
                ...
                >
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider text-purple-200 bg-purple-950/80 px-3 py-1 rounded-full border border-purple-500/40 shadow-lg">Change Photo</span>
                </button>
              )}
            </div>
